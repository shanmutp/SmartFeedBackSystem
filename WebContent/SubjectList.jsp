<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="com.smartfeedback.vo.*,java.util.List"%>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<div id="fh5co-contact">
			<div class="container">
				<div class="row">
					...
					<%
						List<SearchSubjectVO> list = (List<SearchSubjectVO>) request.getAttribute("subjectList");
					%>
					<div class="col-md-6 animate-box">
						...
						<div class="table-responsive">
							<table class="table table-bordered table-hover table-striped ">
								...
								<p class="bg-danger">No Subjects found</p>
								<%
									}
								%>
							</table>
