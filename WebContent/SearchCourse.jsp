<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1" import="com.smartfeedback.vo.CourseVO"%>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<body
	...
	setSelected("CourseNameId","<%=vo.getCourseName()%>");
	setSelected("CourseId",<%=vo.getCourseDescription()%>);'>
	<%
		} else {
	%>
						...
						<form action="SearchCourse" method="post">
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="text" name="courseName" id="CourseNameId"
