<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="com.smartfeedback.vo.SubjectVO,java.util.Map,java.util.Set"%>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<!--[if lt IE 9]>
	...
	<![endif]-->
<%
	SubjectVO vo = (SubjectVO) request.getAttribute("vo");
%>
<%
	if (vo != null) {
%>
				...
				<div class="row">
					...
					<div class="col-md-6 animate-box">
						...
						<fieldset>
							...
							%>
							<p class="bg-success">Subject sucessfully added</p>
							<fieldset disabled>
								<%
									}
								%>
