<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="com.smartfeedback.vo.*,java.util.Map,java.util.Set"%>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<!--[if lt IE 9]>
	...
	<![endif]-->
<%
	CourseVO vo = (CourseVO) request.getAttribute("courseVO");
	CourseVO vo1 = (CourseVO) request.getAttribute("vo");
%>
...
%>
<body
	onLoad='setSelected("courseName","<%=vo.getCourseName()%>");
...
<body
	onLoad='
	setSelected("courseName","<%=vo1.getCourseName()%>");
	setSelected("courseDescription","<%=vo1.getCourseDescription()%>");'>
	<%
		}
	%>
				...
				<div class="row">
					...
					<div class="col-md-6 animate-box">
						<form action="EditCourse" method="get">
							...
							%>
							<h3>Update Course</h3>
							<input type="hidden" value=<%=vo.getCourseID()%> name="courseId" />

							<fieldset>
								<%
									} else if (vo1 != null) {
								%>
								<p class="bg-success">Course sucessfully updated</p>
								<fieldset disabled>
									<%
										}
									%>
									...
									<div class="row form-group">
										<div class="col-md-12">
											...
											Course Desription : <input type="text" id="courseDescription"
